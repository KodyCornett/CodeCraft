    ...
    private const STAGES = [
        ...
        'SV-hub|2' => [
            [
                ...
                'dialogue'           => [
                    ['speaker' => 'NARRATOR', 'audio' => 'narrator/chapter_1/c1_s1_p1_l1.mp3', 'text' => "The diagnostic lead clicks into your collar before you're even conscious enough to feel the cold alloy. You wake up suspended in Float's rig, suspended in static. Your temple is throbbing — a rhythmic, dull-blade pulse right behind your left eye. The shop's ceiling is tilting slowly to the right.", 'fx' => ['type' => 'chromatic(2),flicker(1)', 'duration' => 700]],
        ...
        'UD-hub|2' => [
            [
                ...
                'dialogue'           => [
                    ...
                    ['speaker' => 'NARRATOR', 'audio' => 'narrator/chapter_1/c1_s2_p1_l9.mp3', 'text' => "He rests a hand on the housing's access panel. It doesn't open. He tries again, and this time you hear something inside click without engaging — a small, wrong sound in an otherwise silent room.", 'fx' => ['type' => 'static(2)', 'duration' => 250]],
            ...
            [
                ...
                'dialogue'           => [
                    ...
                    ['speaker' => 'NARRATOR', 'audio' => 'narrator/chapter_1/c1_s2_p2_l6.mp3', 'text' => "Then the shelves shudder—then go still. Not the room. The sound: a hundred folders that were always faintly turning, rustling, snap silent at once. You feel it before you understand it—pressure behind your eyes, like the room just changed altitude.", 'fx' => ['type' => 'static(3),flicker(2)', 'duration' => 500]],
        ...
        'DT-hub|2' => [
            [
                ...
                'dialogue'           => [
                    ...
                    ['speaker' => 'NARRATOR', 'audio' => 'narrator/chapter_1/c1_s3_p1_l14.mp3', 'text' => "She doesn't finish. The word gets halfway out — the Persist— — and something inside your skull goes off like a struck bell.", 'fx' => ['type' => 'static(4),flicker(3),bars(2)', 'duration' => 900]],
