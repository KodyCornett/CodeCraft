...
const MINIGAME_SKIN = {
    ...
    toxic_soak:         { primary: 'DECRYPTED',   stability: 'STABILITY',   brief: 'Crack every letter in the phrase before the timer runs out.', timeLimit: 240, hideBars: true,  dealsDamageOnFail: false },
