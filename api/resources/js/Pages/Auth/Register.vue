    ...
    <div class="login-screen">
        ...
        <div class="login-panel">
            ...
            <div class="lp-header">
                ...
                <div class="lp-subtitle">NEW RUNNER REGISTRATION</div>
                <div class="lp-version">v2.4.1 // OPEN ENROLLMENT</div>
            </div>

            <!-- Status strip -->
            <div class="lp-status">
                <span class="lp-status-dot" />
                <span class="lp-status-text">AWAITING NEW IDENTITY</span>
            </div>
            ...
            <form class="lp-form" @submit.prevent="submit">
                ...
                <div class="lp-field">
                    <label class="lp-label" for="handle">RUNNER HANDLE</label>
                    <input
                        id="handle"
                        v-model="form.handle"
                        class="lp-input"
                        :class="{ 'lp-input--err': errors.handle }"
                        type="text"
                        autocomplete="username"
                        placeholder="YourHandle"
                        autofocus
                    />
                    <span v-if="errors.handle" class="lp-error">{{ errors.handle }}</span>
                </div>

                <div class="lp-field">
                    <label class="lp-label" for="email">EMAIL — CONTACT NODE</label>
                    <input
                        id="email"
                        v-model="form.email"
                        class="lp-input"
                ...
                <div class="lp-field">
                    <label class="lp-label" for="password_confirmation">CONFIRM ACCESS CODE</label>
                    <input
                        id="password_confirmation"
                        v-model="form.password_confirmation"
                        class="lp-input"
                        :class="{ 'lp-input--err': errors.password_confirmation }"
                        type="password"
                        autocomplete="new-password"
                        placeholder="••••••••••••"
                    />
                    <span v-if="errors.password_confirmation" class="lp-error">{{ errors.password_confirmation }}</span>
                </div>
            ...
            <!-- Footer -->
            <div class="lp-footer">
                <span class="lp-footer-line">
                    Already a runner?
                    <a href="/login" class="lp-link">[ AUTHENTICATE ]</a>
                </span>
            </div>
